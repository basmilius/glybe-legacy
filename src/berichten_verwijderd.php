...
$bQuery = DB::Query("SELECT 1 FROM messages pm WHERE pm.user_to_id = '" . $user->Id . "' AND pm.state = 'deleted'");
				...
				<div class="inner">
					<form action="" method="post">
						<div class="psystem" style="float: left;">
							...
							{
								echo'<a href="/berichten/verwijdert?p=' . $value[1] . '"><div class="item">' . $value[0] . '</div></a>';
							}
							?>
							<div class="clear"></div>
						</div>
